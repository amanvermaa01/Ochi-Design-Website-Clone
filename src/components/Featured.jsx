...
const Featured = () => {
  ...
  return (
    <div className="w-full py-10">
      <div className="w-full px-20 mb-30 border-b-[1px] border-zinc-700 pb-20">
        <h1 className="text-8xl font-light tracking-tight">
          Featured Projects
        </h1>
      </div>
      <div className="px-20">
        <div className="cards1 w-full flex gap-10 mt-10">
          <motion.div
            onHoverStart={() => handleHover(0)}
            onHoverEnd={() => handleHoverEnd(0)}
            className="cardcontainer relative w-1/2 h-[75vh] "
          >
            <h1 className="absolute flex overflow-hidden text-[#CDEA68] left-0 -translate-x-1/2 top-1/2 -translate-y-1/2 z-[9] text-8xl leading-none tracking-tighter font-sans uppercase">
            ...
            <div className="card w-full h-full rounded-xl overflow-hidden ">
              <img
                className=" card w-full h-full bg-cover"
          ...
          <motion.div
            ...
            className="cardcontainer relative w-1/2 h-[75vh]"
          >
            <h1 className="absolute flex overflow-hidden text-[#CDEA68] right-full -translate-x-1/2 top-1/2 -translate-y-1/2 z-[9] text-8xl leading-none tracking-tighter font-sans uppercase">
