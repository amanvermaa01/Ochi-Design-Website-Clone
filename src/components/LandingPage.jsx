              ...
              <div className="w-fit flex items-end overflow-hidden">
                {index === 1 && (
                  <motion.div
                    ...
                    className=" mr-[1vw] w-[8vw] rounded-md h-[7vw] relative top-[1vw] bg-green-500"
                  ></motion.div>
                )}
                <h1 className='flex items-center uppercase text-[9vw] h-full leading-[7vw] tracking-tighter font-["Founders Grotesk"] font-small'>
                  {item}
                </h1>
              </div>
            </div>
